...
# backend/resume_parser/skill_extractor.py -> TalentGraph/ (3 levels up)
BASE_DIR: Path = Path(__file__).resolve().parent.parent.parent
SECTION_ALIASES_PATH: Path = BASE_DIR / "configs" / "section_aliases.json"
DEFAULT_SKILLS_ALIASES_PATH: Path = BASE_DIR / "datasets" / "skills_aliases.csv"
